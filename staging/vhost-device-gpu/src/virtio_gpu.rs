...
use crate::{
    ...
    protocol::{
        ...
        GpuResponse::{
            ...
            OkCapsetInfo, OkDisplayInfo, OkEdid, OkMapInfo, OkNoData, OkResourcePlaneInfo,
        },
...
impl VirtioGpuResource {
    ...
    pub fn new_3d(resource_id: u32, width: u32, height: u32) -> Self {
        Self {
            id: resource_id,
            width,
            height,
    ...
    pub fn new_blob(resource_id: u32, blob_size: u64) -> Self {
        Self {
            id: resource_id,
            width: 0,
            height: 0,
